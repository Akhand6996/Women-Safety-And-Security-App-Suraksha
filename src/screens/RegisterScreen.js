    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Join Suraksha </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  backArrow: { fontSize: 22, color: COLORS.text, fontFamily: FONT_FAMILY.regular },
  logoWrap: {
    width: 64, height: 64, borderRadius: 32,
    backgroundColor: COLORS.primaryLight,
    alignItems: 'center', justifyContent: 'center', marginBottom: 12,
  },
  logoIcon: { fontSize: 28, fontFamily: FONT_FAMILY.regular },
  title: { fontSize: SIZES.xxl, fontWeight: '700', color: COLORS.text, marginBottom: 4, fontFamily: FONT_FAMILY.bold },
  ...
  errorText: { fontSize: 11, color: COLORS.primary, fontFamily: FONT_FAMILY.regular },
  privacyBox: {
  ...
  privacyText: { fontSize: 12, color: COLORS.info, lineHeight: 18, fontFamily: FONT_FAMILY.regular },
  registerBtn: {
